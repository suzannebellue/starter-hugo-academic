...
summary: "In the United States, less-educated parents tend to allocate little time to parent-child activities, reside in bad neighborhoods, and underestimate the relevance of parental inputs for later life outcomes. To rationalize these patterns, I introduce social learning in a spatial model of overlapping generations with imperfect information about the relevance of the two parental inputs: neighborhood quality and parental time. The learning mechanism assumes parents have inferred the relevance of parental inputs using the information within their childhood neighborhood but are prone to misinferences as they may not fully correct for selection induced by residential segregation. The United States calibrated model matches targeted and non-targeted parental behavior moments across socioeconomic groups. I find a relatively modest level of parental delusion that increases income inequality by 3% (income Gini index) and decreases social mobility by 14% (intergenerational rank-rank). A housing voucher policy improves the neighborhood quality of eligible families, raising children's future earnings. When scaling up the policy, long-run and general equilibrium responses in parental beliefs amplify the policy effects. Inequality reduces, and intergenerational mobility improves."
featured: yes
full_abstract: false
